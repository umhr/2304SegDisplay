...
:: Android packaging
set AND_CERT_NAME="SevenSegmentDisplay"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SevenSegmentDisplay.p12
...
set IOS_PROVISION=cert\SevenSegmentDisplay.mobileprovision
...
set APP_ID=jp.mztm.SevenSegmentDisplay

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SevenSegmentDisplay
